  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="max-w-md w-full">
        <h1 className="text-3xl font-bold text-center text-primary mb-2">Join CenturyFit</h1>
        <p className="text-muted-foreground text-center mb-8">
          Start your journey to 100 every day
        </p>

        <div className="space-y-4">
          <button
            className="w-full py-3 px-4 bg-primary text-primary-foreground rounded-lg font-semibold"
            onClick={() => alert('Sign up with Google would appear with Clerk keys configured')}
          >
            Sign up with Google
          </button>
          ...
          <button
            ...
            onClick={() => alert('Sign up with Apple would appear with Clerk keys configured')}
          >
            Sign up with Apple
          </button>
